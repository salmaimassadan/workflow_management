...
.dropdown-content a:hover {
	...
	<title>USER C2M</title>
</head>
<body>
	<!-- SIDEBAR -->
	<section id="sidebar">
		<a href="{{ route('utilisateur.dashboard') }}" class="brand">
			<i class='bx bxs-smile'></i>
			<span class="text">USER C2M</span>
		</a>
		<ul class="side-menu top">
			<li class="active">
				<a href="{{ route('utilisateur.dashboard') }}">
			...
			<li>
				<a href="{{ route('utilisateur.dossiersindex' ) }}">
					<i class='bx bxs-dashboard'></i>
					<span class="text">My Directories</span>
				</a>
			</li>
		...
		<ul class="side-menu">
			<li id="profile-menu">
				...
				<ul id="profile-sections">
					<li>
						<a href="{{ route('utilisateur.edit-profile', $user->id) }}">
							<i class='bx bxs-edit-alt'></i>
							<span class="text">Update Profile</span>
						</a>
					</li>
					<li>
						<a href="{{ route('utilisateur.edit-password', $user->id) }}">
    ...
    <a href="#" class="notification">
        ...
        <span class="num">{{ $notifications->where('read_status', 'non lu')->count() }}</span>
    </a>
    <div class="dropdown-content">
        <div class="dropdown-body">
            @if($notifications->count())
                @foreach($notifications as $notification)
                    <a href="{{ route('utilisateur.showNotification', $notification->id) }}">
		...
		<main>
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						<li>
							<a href="{{ route('utilisateur.dashboard') }}">Dashboard</a>
						</li>
    ...
    .then(data => {
        if (data.status === 'success') {
            // Optionally reload the page to reflect changes or update the DOM dynamically
            location.reload();
        } else {
