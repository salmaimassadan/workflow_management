...
<body>
    ...
    <div class="order">
        <div class="head">
            ...
            <form id="filter-form" method="GET" action="{{ route('utilisateur.dashboard') }}" class="filter-form">
    ...
    $(document).ready(function() {
        function fetchResults(page = 1) {
            ...
            $.ajax({
                ...
                data: formData,
                beforeSend: function() {
                    $('#loading-spinner').show(); // Ensure you have a loading spinner in your view
                },
                success: function(response) {
                    // Update the tbody with new results
        ...
        // Trigger fetchResults on filter input changes
