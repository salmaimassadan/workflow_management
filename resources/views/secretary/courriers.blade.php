                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex mb-3">
                            ...
                            <!-- Search Form -->
<form id="searchForm" action="{{ route('secretary.index') }}" method="GET" class="flex-grow-1">
...
<!-- Filter Form -->
<form id="filterForm" method="GET" action="{{ route('secretary.index') }}" class="filter-form">
