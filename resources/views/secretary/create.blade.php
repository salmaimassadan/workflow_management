        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('secretary.upload.process') }}" method="POST" enctype="multipart/form-data">
                        @csrf
    ...
    <div class="row mt-4">
        <div class="col-md-8 offset-md-2">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('secretary.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
