		...
		<ul class="side-menu top">
			...
			<li>
				<a href="{{ route('dossiers.index') }}">
					...
					<span class="text">All Directories</span>
				</a>
			</li>
			<li>
				<a href="{{ route('courriers.index') }}">
					<i class='bx bxs-message-dots'></i>
					<span class="text">All Courriers</span>
				</a>
			</li>
			<li>
				<a href="{{ route('distributions.index' ) }}">
					<i class='bx bxs-group'></i>
					<span class="text">All Distributions</span>
				</a>
			</li>
			<li>
				<a href="{{ route('answers.index' ) }}">
					<i class='bx bxs-group'></i>
					<span class="text">All Responses</span>
				</a>
			</li>
		</ul>
		<ul class="side-menu">
			<li id="profile-menu">
				...
				<ul id="profile-sections">
					<li>
						<a href="{{ route('users.edit-profile', $user->id) }}">
